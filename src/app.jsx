    ...
    return (
      <div className="row">
        <div id="owner-info" className="col-sm-12">
          <a href="#" className="button-style" onClick={this.props.resetAll}>Reset All</a>
        </div>
      </div>
    );
  }
...
class Movies extends React.Component {
  ...
  updateMovies() {
    superagent
      ...
      .end((err, res) => {
        ...
        for (let movie in moviesOrder) {
          if (apiMovies.indexOf(moviesOrder[movie]) == -1) {
            this.createMovie(moviesOrder[movie]);
          }
        }
      });
  }
  ...
  render() {
    ...
    if (this.state.owner == true) {
      var owner = (
        <Owner resetAll={this.resetAll.bind(this)} />
      )
    }
